// Registers FaceLandmarksPlugin.swift with VisionCamera's Frame Processor
// runtime under the JS-visible name "detectFaceLandmarks" (see src/sensors/faceLandmarkCamera.ts).
//
...
VISION_EXPORT_SWIFT_FRAME_PROCESSOR(FaceLandmarksPlugin, detectFaceLandmarks)
